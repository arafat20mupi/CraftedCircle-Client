  ...
  const links = (
    <>
      ...
      <div className="tooltip tooltip-bottom" data-tip="Jobs">
        <Link to={"/jobs"}>
          <RiUserSearchFill className="text-black" />
        </Link>
      </div>
    </>
  );
      ...
      <div className="grid grid-cols-3 items-center p-2 gap-4">
        ...
        <div className="flex items-center space-x-2 col-span-2 sm:col-span-1">
          ...
          <div className="relative">
            ...
            />
            {!isFocused && (
              <IoMdSearch className="absolute left-3 top-1/2 transform -translate-y-1/2" />
            )}
          </div>
        </div>
        ...
        <div className="col-span-1 flex items-center justify-self-end">
          <div
            ...
            data-tip="Chat"
            className="hover:bg-gray-200 duration-200 tooltip tooltip-bottom rounded-full cursor-pointer active:scale-95 p-2 mx-3"
          >
